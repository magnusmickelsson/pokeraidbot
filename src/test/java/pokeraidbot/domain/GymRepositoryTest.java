...
public class GymRepositoryTest {
    ...
    public void allGymsAreReadForUppsala() {
        assertThat(repo.getAllGymsForRegion("uppsala").size(), is(231));
    }
    ...
    public void allGymsAreReadForLulea() {
        assertThat(repo.getAllGymsForRegion("luleå").size(), is(90));
    }

    @Test
    public void allGymsAreReadForUmea() {
        assertThat(repo.getAllGymsForRegion("umeå").size(), is(137));
    }

    @Test
    public void allGymsAreReadForTrollhattan() {
        assertThat(repo.getAllGymsForRegion("trollhättan").size(), is(76));
    }
    ...
    public void allGymsAreReadForVannas() {
        assertThat(repo.getAllGymsForRegion("vännäs").size(), is(12));
    }
