...
public class GymRepositoryTest {
    ...
    public void allGymsAreReadForUppsala() {
        assertThat(repo.getAllGymsForRegion("uppsala").size(), is(226));
    }
    ...
    public void allGymsAreReadForLulea() {
        assertThat(repo.getAllGymsForRegion("luleå").size(), is(89));
    }

    @Test
    public void allGymsAreReadForUmea() {
        assertThat(repo.getAllGymsForRegion("umeå").size(), is(130));
    }

    @Test
    public void allGymsAreReadForTrollhattan() {
        assertThat(repo.getAllGymsForRegion("trollhättan").size(), is(74));
    }

    @Test
    public void allGymsAreReadForVindeln() {
        assertThat(repo.getAllGymsForRegion("vindeln").size(), is(4));
    }
